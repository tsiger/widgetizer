/**
 * Canonical list of setting types supported by the editor's SettingsRenderer.
 *
 * This is the single source of truth shared between:
 *   - the frontend settings renderer
 *     (@widgetizer/editor-ui src/components/settings/SettingsRenderer.jsx)
 *   - backend collection-type schema validation
 *     (@widgetizer/builder-server src/services/collectionService.js)
 *
