...
/**
 * Desktop/mobile preview switcher — the shared chrome used by the standalone site
 * preview (page + collection item). A `bg-slate-200` pill with `Monitor`/`Smartphone`;
 * the active mode is `bg-white text-pink-600`.
 *
 * @param {Object} props
