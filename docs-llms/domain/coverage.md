...
| M4 Refuse in-use deletion / bulk outcomes | [Delete](operations/media.md#delete-or-bulk-delete) | [media](../../packages/builder-server/src/tests/media.test.js) | Located | Surviving second-language reference; partial asset deletion; refresh failure with unreadable content |
