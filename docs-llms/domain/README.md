...
Start with a [project](entities/project.md), then look inside one [page](entities/page.md), one [widget](entities/widget.md) and one [block](entities/block.md). Next, read about the [shared header/footer](entities/global-widget.md), [menus](entities/menu.md), [collections](entities/collection.md) and [media library](entities/media.md). Finish with [languages](multilingual.md) and the [operation walkthroughs](operations/README.md).
