...
export const getProjectCollectionsDir = (projectId) =>
  path.join(getProjectDir(projectId), "collections");
...
export const getThemeCollectionsDir = (themeId) =>
  path.join(getThemeDir(themeId), "collections");
