...
- **Accent color schemes add depth without heaviness.** The `standard-secondary` and `highlight-secondary` schemes give accordion items a secondary background, which helps them stand out on pages that already have a lot of flat white space.
