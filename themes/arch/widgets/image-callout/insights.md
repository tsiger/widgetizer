...
| `color_scheme` | `standard`, `standard-accent`, `highlight`, `highlight-accent` | `standard` keeps a transparent outer wrapper (content blends with page background). The other three add a padded, colored container behind the entire widget, making it read as a distinct band on the page |
...
**Settings:** image_position `left`, color_scheme `standard`
...
**Settings:** image_position `right`, color_scheme `highlight`
...
**Widget A:** image_position `left`, color_scheme `standard`, top/bottom spacing `auto`
**Widget B:** image_position `right`, color_scheme `standard`, top_spacing `none`
...
**Settings:** image_position `left`, color_scheme `highlight-accent`
...
**Settings:** image_position `right`, color_scheme `standard-accent`
...
**Settings:** image_position `right`, color_scheme `standard`
...
- **Color scheme controls prominence.** Use `standard` when the callout lives among other colored sections and needs to breathe. Switch to `highlight` or an accent variant when the callout is the single most important conversion moment on the page and needs a background band to visually separate it.
