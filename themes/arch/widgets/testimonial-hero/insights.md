...
- Settings: `image_position: start`, `color_scheme: standard`, `logo: (empty)`, `author_image: casual-customer-photo.jpg`
...
- Settings: `image_position: start`, `color_scheme: highlight`, `logo: (empty)`, `author_image: after-transformation.jpg`
...
- Settings: `image_position: end`, `color_scheme: standard`, `top_spacing: none`, `bottom_spacing: none`, `logo: startup-logo.svg`, `author_image: candid-founder-photo.jpg`
