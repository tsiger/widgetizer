...
- **Settings:** `heading_alignment: center`, `sidebar_position: left`, `color_scheme: standard-secondary`, `week_start_day: 0`, `eyebrow: "Plan Your Visit"`, `title: "We're Open"`
...
- **Settings:** `heading_alignment: left`, `sidebar_position: right`, `color_scheme: highlight-secondary`, `title: "Gym Hours"`, `note: "Staffed hours may differ -- see front desk"`
...
- **Settings:** `heading_alignment: left`, `sidebar_position: right`, `color_scheme: standard-secondary`, `title: "Office Hours"`, `eyebrow: "By Appointment"`, `note: "Walk-ins welcome Mon-Wed only"`
...
- **Color scheme accent variants pair well with adjacent neutral widgets.** Using `highlight-secondary` on the schedule table between two `standard-primary` widgets draws the eye to hours without repainting the whole page.
