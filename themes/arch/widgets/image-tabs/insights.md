...
| `heading_alignment` | `start` | Centers or left-aligns the eyebrow/title/description block; left suits editorial layouts |
...
- **Settings:** `heading_alignment: center`, `image_position: start`, `color_scheme: standard`, eyebrow "What We Do"
...
- **Settings:** `heading_alignment: start`, `image_position: end`, `color_scheme: highlight`, title "How It Works"
...
- **Settings:** `heading_alignment: center`, `image_position: start`, `color_scheme: standard-secondary`, eyebrow "Platform", title "Built for Your Workflow"
...
- **Settings:** `heading_alignment: start`, `image_position: end`, `color_scheme: standard`, `top_spacing: none`, title "Explore Our Space"
...
- **Settings:** `heading_alignment: center`, `image_position: end`, `color_scheme: standard`, title "Our Menu"
