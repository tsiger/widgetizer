 ...
 * preview and the collection item preview: a centered, full-height iframe capped
 * at `max-width` (24rem in mobile, 100% desktop) with a `shadow-2xl` in mobile and
 * a `bg-white`↔`bg-slate-200` background swap. No device "bezel" chrome.
 *
 * @param {Object} props
